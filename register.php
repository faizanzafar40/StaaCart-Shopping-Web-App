...
<!-- register -->
	<div class="register">
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s">Register and join our family of consumers worldwide</p>
			<div class="login-form-grids">
				<h5 class="animated wow slideInUp" data-wow-delay=".5s" style="text-align: center;">Your information</h5>
				<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" class="animated wow slideInUp" data-wow-delay=".5s">
					<input type="text" name = "name" placeholder="First Name" required=" " value="<?php echo $name ?>">
					<input type="text" placeholder="Surname" required=" " >
					<input type="email" name = "email" placeholder="Email Address" required=" " value="<?php echo $email ?>">
					<input type="password" placeholder="Password" required=" " value="<?php echo $pass ?>">
					<input type="password" name = "pass" placeholder="Password Confirmation" required=" " value="<?php echo $pass ?>">
				...
				<div class="register-check-box">
					...
					<button type="submit" id = "btn-signup" name="btn-signup" value="Register">Register</button>
				</form>
			</div>
