...
<!-- team -->
	<div class="login">
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s">Get to know and trust us</p>
			<div class="teambox">
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
			<div class="about">
				<h5>Mission Statement</h5><p><br> To offer an online, easy to use, cost effective, quality guaranteed, service orientated product purchasing method for customers for personal use and/or small business. Local based service and community responsibility, coupled with purchasing convenience are the cornerstones of our business model.</p><br><br><h5>Vision</h5><p><br>To become the pioneer of shopping portal of choice, while maintaining a standardized service. To create a personalized environment for customers to enhance a sense of belonging. To provide the convenient way of purchase.</p><br><br><h5>Privacy Policy</h5><p><br>By visiting our websites, using our products or services or otherwise submitting Personal Information through our websites, you agree to the terms of this Privacy Policy.</p>
				</div>
				</div>
			</div>
			<!-- collections-bottom -->
...
<div class="collections-bottom">
		<div class="container">
			    ...
			    <div class="teampic">
				<div class="teamdata animated wow slideInUp" data-wow-delay=".5s">
