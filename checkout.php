...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s">Your shopping cart contains: <span>2 Products</span></h3>
			<div class="checkout-right animated wow slideInUp" data-wow-delay=".5s">
				<table class="timetable_sub">
					...
					<tr class="rem1">
						...
						<td class="invert-image"><a href="single.php"><img src="images/si.jpg" alt=" " class="img-responsive" /></a></td>
						<td class="invert">Formal Shirt<br>Marks & Spencer</td>
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="single.php"><img src="images/tablelamp.jpg" alt=" " class="img-responsive" /></a></td>
						<td class="invert">Table Lamp<br>Caracole</td>
						<td class="invert">$480.00</td>
						<td class="invert">$5.00</td>
						<td class="invert">
							<div class="rem">
			...
			<div class="checkout-left">	
				<div class="checkout-left-basket animated wow slideInLeft" data-wow-delay=".5s">
					<h4><a href="#">Continue to Basket</a></h4>
					<ul>
						<li>Formal Shirt<span>$250.00 </span></li>
						<li>Table Lamp <span>$480.00 </span></li>
						<li>Total Service Charges  <span>$10.00</span></li>
						<li>Total<span>$740.00</span></li>
					</ul>
				</div>
