		...
		<input type="range" name="price" min="0" max="100" value="30" />
				...
				<div class="categories animated wow slideInUp" data-wow-delay=".5s">
					...
					<ul class="cate">
						...
						<li><a href="products.php">Men's Fashion</a> <span>(16)</span></li>
							<ul>
								<li><a href="products.php">Accessories</a> <span>(2)</span></li>
								<li><a href="products.php">Coats</a> <span>(5)</span></li>
						...
						<li><a href="products.php">Women's Fashion</a> <span>(15)</span></li>
							<ul>
								<li><a href="products.php">Accessories</a> <span>(2)</span></li>
								<li><a href="products.php">New Arrivals</a> <span>(0)</span></li>
				...
				<div class="new-products animated wow slideInUp" data-wow-delay=".5s">
					<h3>Latest in line</h3>
					<div class="new-products-grids">
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single.php"><img src="images/pearl.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4><a href="single.php">Necklace</a></h4>
								<div class="rating">
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single.php"><img src="images/coat.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4><a href="single.php">Womens Coat</a></h4>
								<div class="rating">
									<div class="rating-left">
										<img src="images/2.png" alt=" " class="img-responsive">
									</div>
						...
						<div class="new-products-grid">
							<div class="new-products-grid-left">
								<a href="single.php"><img src="images/belt.jpg" alt=" " class="img-responsive" /></a>
							</div>
							<div class="new-products-grid-right">
								<h4><a href="single.php">Gucci belt</a></h4>
								<div class="rating">
									<div class="rating-left">
										<img src="images/2.png" alt=" " class="img-responsive">
									</div>
								...
								<div class="simpleCart_shelfItem new-products-grid-right-add-cart">
									<p> <span class="item_price">$260</span><a class="item_add" href="#">add to cart </a></p>
								</div>
							</div>
							<div class="clearfix"> </div>
						</div>
				...
				<div class="products-right-grid">
					...
					<div class="products-right-grids-position animated wow slideInRight" data-wow-delay=".5s">
						...
						<div class="products-right-grids-position1">
							...
							<p>Shop from our new collection of the best brands</p>
						</div>
					</div>
				</div>
				<div class="products-right-grids-bottom">
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
								<a href="single.php" class="product-image"><img src="images/si.jpg" alt=" " class="img-responsive"></a>
					...
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							...
							<h4><a href="single.php">Check Shirt</a></h4>
							<p>Polo</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							...
							<h4><a href="single.php">Long boots</a></h4>
							<p>Timberland</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							...
							<h4><a href="single.php">Waistcoat</a></h4>
							<p>Raymond</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i>$585</i> <span class="item_price">$490</span><a class="item_add" href="#">add to cart </a></p>
							</div>
						</div>
					</div>
					<div class="col-md-4 products-right-grids-bottom-grid">
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							...
							<h4><a href="single.php">Full Shirt</a></h4>
							<p>Peters</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
						...
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							...
							<h4><a href="single.php">Sneakers</a></h4>
							<p>Crocs</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i>$200</i> <span class="item_price">$150</span><a class="item_add" href="#">add to cart </a></p>
							</div>
						</div>
						<div class="new-collections-grid1 products-right-grid1 animated wow slideInUp" data-wow-delay=".5s">
							<div class="new-collections-grid1-image">
							...
							<h4><a href="single.php">Trench Coat</a></h4>
							<p>Clarks</p>
							<div class="simpleCart_shelfItem products-right-grid1-add-cart">
								<p><i>$585</i> <span class="item_price">$489</span><a class="item_add" href="#">add to cart </a></p>
							</div>
