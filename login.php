...
<!-- login -->
	<div class="login">
		<div class="container">
			...
			<p class="est animated wow zoomIn" data-wow-delay=".5s">Sign in with your credentials for a personalized experience</p>
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
					<input type="email" placeholder="Email Address" name = "email" required=" " value="<?php echo $email; ?>">
					<input type="password" placeholder="Password" name = "pass" required=" " >
					<div class="forgot">
						<button class="forget"><a class="for" href="#">Forgot Password?</a></button>
					</div>
					<button type="submit" name = "btn-login" value="Login">Login</button>
				</form>
			</div>
			<h4 class="animated wow slideInUp" data-wow-delay=".5s">For new customers</h4>
			<p class="animated wow slideInUp" data-wow-delay=".5s"><a href="register.php">Register Here</a> or visit <a href="index.php">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- footer -->
